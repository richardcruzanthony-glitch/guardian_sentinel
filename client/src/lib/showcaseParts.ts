  ...
  },
  {
    ...
    result: {
      ...
      summary: {
        ...
        isAssembly: true,
        bomComponents: [
          { partNumber: 'JA-001', description: 'Base', material: 'Steel AISI 1020', quantity: 1, operation: 'OP-10/OP-20 (Mill + Tap)', leadTime: '3 days' },
          { partNumber: 'JA-002', description: 'Swivel', material: 'Steel AISI 1020', quantity: 1, operation: 'OP-30/OP-40 (Lathe + Knurl)', leadTime: '3 days' },
          { partNumber: 'JA-003', description: 'Bolt M20x2.5', material: 'Steel AISI 1020', quantity: 1, operation: 'OP-50 (Lathe)', leadTime: '2 days' },
          { partNumber: 'JA-004', description: 'Standard Nut M16x2.0', material: 'Steel', quantity: 1, operation: 'Purchased', leadTime: '1 day' },
          { partNumber: 'JA-005', description: 'Lock Nut', material: 'Steel', quantity: 1, operation: 'Purchased', leadTime: '1 day' },
          { partNumber: 'JA-006', description: 'Screw M20x2.5', material: 'Steel AISI 1020', quantity: 1, operation: 'OP-60 (Assembly)', leadTime: '1 day' },
        ],
      },
